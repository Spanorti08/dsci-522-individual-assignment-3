---
title: "Quarto Example Report"
author: "Songyang (Norton) Yu"
format:
  html:
    toc: true
    toc-depth: 2
...
```{python}
#| label: fig-hist
#| fig-cap: "Horse populations for all provinces in Canada (1906–1972)"
#| echo: false
...
We can see from @fig-hist that Ontario, Saskatchewan and Alberta 
